<style lang="less">
@import "../excel/editable-table.less";
</style>

<template>
    <div>
        <Table height="200"  width="800" :ref="refs" :columns="columnsList" :data="thisTableData" border disabled-hover></Table>
    </div>
</template>
